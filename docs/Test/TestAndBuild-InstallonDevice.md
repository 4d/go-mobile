...
![Build tab](../assets/en/Open-your-project-Xcode-4D-for-iOS.png) 
...
![Account-Selection](../assets/en/account-Selection-Free-Account.png) 

* Connect your device to your computer and select it from the top menu in Xcode.

![Select your device](../assets/en/select-device-Free-Account.png) 
...
![Install button](../assets/en/Install-button-build-tab-4D-for-iOS.png) 
...
![Manual installation](../assets/en/Manual-installation-4D-for-iOS.png) 

* An archive of your project is created

![Archive creation](../assets/en/Archive-creation.png) 

* Reveal the generated archive in Finder

![Reveal archive in Finder](../assets/en/Reveal-archive-in-Finder.png) 
...
![Devices and Simulators](../assets/en/Devices-and-Simulators-4D-for-iOS.png) 
