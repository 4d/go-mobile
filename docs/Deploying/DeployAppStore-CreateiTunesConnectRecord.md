...
![App ID](../../assets/en/Developer-account-App-ID.png)

* Define the App Services to include in your app

![App Services](../../assets/en/App-Services-to-include.png)

* Confirm your App ID by clicking **Register**.

![Confirm App ID](../../assets/en/Confirm-App-ID.png)
...
![App Store Connect](../../assets/en/App-Store-Connect-home-page.png)

## STEP 3. Create a new iOS App

Click the **+** sign in the top left corner to create a new iOS App. 

![Create a new iOS App](../../assets/en/Create-new-iOS-App.png)
...
![Change BundleID](../../assets/en/Change-BundleID-Xcode-Project.png)
...
![App information](../../assets/en/App-Store-Connect-app-information.png)
...
![Prepare for Submission](../../assets/en/Prepare-for-submission-screenshot-description.png)
...
![iOS App section](../../assets/en/Prepare-for-submission-build-icon.png)
...
![App Review Information](../../assets/en/Prepare-for-submission-review-information.png)
