...
![Action section](../../assets/en/Actions-section-4D-for-iOS.png)
...
![Action parameters](../../assets/en/Actions-parameters-4D-for-iOS.png)
...
![Add actions](../../assets/en/Actions-Add-action-4D-for-iOS.png)
...
![Delete actions](../../assets/en/Actions-Delete-action-4D-for-iOS.png)
...
![Entity Lisform Tableview](../../assets/en/ListForm-entity-action-tableview.png)

* **Table actions:** A generic actions button is available in the navigation bar to display a list of available table actions.

![Table Listform Tableview](../../assets/en/ListForm-table-action-tableview.png)
...
![Entity Listform Collectionview](../../assets/en/ListForm-entity-action-collectionview.png)
...
![Table Listform Collectionview](../../assets/en/ListForm-table-action-collectionview.png)
...
![Entity Detailform](../../assets/en/Detailform-final.png)
