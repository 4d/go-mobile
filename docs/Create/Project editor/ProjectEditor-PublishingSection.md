...
![Publishing section](../../assets/en/Publishing-section-4D-for-iOS.png)
...
![Mobile App Session Management](../../assets/en/Mobile-App-Session-Management.png)
...
![Mobile App Session selection](../../assets/en/Mobile-App-Session-Management-selected.png)
...
![Login & Settings screen](../../assets/en/Login-Settings-screen-Publishing-section-4D-for-iOS.png)
...
![Reset remote url](../../assets/en/Reset-remote-url.png)

* Then restart your app to reset the server address 
* And finally define the new remote url

![Update remote url](../../assets/en/Update-remote-url.png)