...
![Push notification process](../../assets/en/4D-for-ios-push-notification.png)
...
![Publishing section](../../assets/en/push-notification-publishing-section.png)
...
```
![Data synchronization animation](../../assets/en/pushandSynchro.gif)
