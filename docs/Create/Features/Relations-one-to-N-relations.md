...
![Task App Final result](../../assets/en/4D-for-iOS-dark-mode-card-relation-ios-13.gif)

But first, let's have a look at the structure of our database:

![Select link from structure section](../../assets/en/Database-1-to-N-relations-4D-for-iOS.png)
...
![Structure section Relations properties](../../assets/en/Structure-section-relations-4D-for-iOS.png)
...
![Labels & Icons section Relations properties](../../assets/en/Relations-properties-Labels-icons-section-4D-for-iOS.png)

## Forms section

* Go to the Forms section and drop the *tasks* relation on the Employee Task Detail form.

![Related field in Forms section](../../assets/en/1-to-n-relations-forms-section.png)
...
![Related field in Forms section](../../assets/en/One-to-n-relations-task-ios-app.png)
