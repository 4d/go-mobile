...
![User information query](../../assets/en/user-information-query.png)
...
![User information query](../../assets/en/database-method-user-information-query.png)
...
![Final result](../../assets/en/restricted-queries-final-result.png)
