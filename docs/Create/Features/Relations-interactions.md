...
![Publish relations from Structure section](../../assets/en/structure-section.gif)
...
![length parameter](../../assets/en/icons-labels-length-parameter-relation.png)
...
![Drop relations list and detail forms](../../assets/en/drop-relation-list-detail-form.gif)
...
![Clickable fields](../../assets/en/clickable-fields-relation.gif)
...
![Many to many relation](../../assets/en/many-to-many-relations.gif)
...
![Many to One relation](../../assets/en/many-to-one-relations.gif)
...
![length for one to many](../../assets/en/length-for-one-to-many.png)
