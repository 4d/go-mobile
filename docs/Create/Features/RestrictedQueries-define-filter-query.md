...
![iOS app without queries](../../assets/en/ios-app-without-queries.png)
...
![CRM database](../../assets/en/filterquery.png)
...
![iOS app with basic query](../../assets/en/restrited-queries-basic-query.png)
