...
Docusaurus supports the [Markdown](https://daringfireball.net/projects/markdown/syntax) syntax and has some additional features.file:///C:/GitDocv2/my-website/docs/getting-started.md
