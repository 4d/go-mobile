...
![Publishing section](assets/en/publishing-section.png)
...
![Login form](assets/en/login-form.png)
...
![Create QRCode](assets/en/create-QRCode.png)

You will be redirected to the final QRCode page.

![Generated QRCode](assets/en/generated-QRCode.png)
...
![Sign in with QRCode](assets/en/sign-in-with-QRCode.gif)
