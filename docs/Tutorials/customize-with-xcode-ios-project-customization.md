...
![Final result](../../assets/en/Simlator-Before-After-Xcode-4D-for-iOS.png)
...
![Attributes inspector](../../assets/en/Attributes-inspector-Xcode-4D-for-iOS.png)

* Change the font from Helvetica Neue Bold to Futura Bold. 

![Attributes inspector font](../../assets/en/Attributes-inspector-font-Xcode-4D-for-iOS.png)

* You can also change the color of the font from the same pane.

![Attributes inspector color](../../assets/en/Attributes-inspector-color-Xcode-4D-for-iOS.png)
...
![Simulator result](../../assets/en/Simlator-Final-Xcode-4D-for-iOS.png)
...
![Profil picture position](../../assets/en/Profil-picture-position-Xcode-4D-for-iOS.png)
...
![Profil picture constraints](../../assets/en/Profil-picture-constraints-Xcode-4D-for-iOS.png)
...
![Profil picture Align](../../assets/en/Profil-picture-Align-Xcode-4D-for-iOS.png)

Next, click on the **Add New Constraints** button and add a leading space constraint (the left constraint).

![Profil picture new constraints](../../assets/en/Profil-picture-new-constraints-4D-for-iOS.png)
...
![First Name Label position](../../assets/en/First-Name-Label-position-Xcode-4D-for-iOS.png)
...
![First Name Label top constraint](../../assets/en/First-Name-Label-top-constraint-Xcode-4D-for-iOS.png)
...
![Last Name Label position](../../assets/en/Last-Name-Label-position-Xcode-4D-for-iOS.png)
...
![Last Name Label constraint](../../assets/en/Last-Name-Label-constraint-Xcode-4D-for-iOS.png)

Both of your name labels are now repostioned. 

Let's see the results in the Simulator !

![Simulator result](../../assets/en/Simulator-Xcode-4D-for-iOS.png)
...
![Labels Alignment](../../assets/en/Labels-Alignment-Xcode-4D-for-iOS.png)
...
![Constraints adjustments](../../assets/en/Constraints-adjustments-Xcode-4D-for-iOS.png)
