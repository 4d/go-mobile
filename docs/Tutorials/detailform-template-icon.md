...
![Custom detailform template](../../assets/en/custom-detailform-template.png)
...
![Missing listform icon custom template](../../assets/en/missing-detailform-icon-custom-template.png)

We've used Photoshop to create the detail form template icon in our example, but you can use any image software.

![Custom listform template icon](../../assets/en/custom-detail-form-icon.png)
