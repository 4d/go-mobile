...
![Storyboard custom listform](../../assets/en/storyboard-custom-listform.png)
...
![Empty storyboard custom template](../../assets/en/empty-storyboard-custom-template.png)
...
![Add Image View storyboard](../../assets/en/add-imageview-storyboard.png)
...
![Image View leading space width height](../../assets/en/imageview-leading-space-width-height.png)
...
![Image View align vertically](../../assets/en/imageview-align-vertically.png)

Your Image View is now well positioned!

![Image View final](../../assets/en/imageview-final.png)
...
![Add View Storyboard](../../assets/en/add-view-storyboard.png)
...
![View position height and width](../../assets/en/view-position-height-width.png)
...
![View contraints Storyboard](../../assets/en/view-constraints-storyboard.png)

Drag and drop a label into the View you just added from the Object Library.

![Add label Storyboard](../../assets/en/add-label-storyboard.png)
...
![Duplicate the label](../../assets/en/duplicated-label-storyboard.png)
...
![Labels contraints storyboard](../../assets/en/labels-contraints-storyboard.png)

With a label selected, double-click on the **Height constraint** to edit it. 

![Label height constraint edition](../../assets/en/label-height-constraint-edition.png)

Change the relation from Equal to **Greater Than or Equal** so it can have a variable height (to handle multiline labels). 

![Change relation label height constraint](../../assets/en/change-relation-label-height-constraint.png)
...
![Label color dark grey](../../assets/en/label-color-dark-grey.png)

You can also select the dominant color for your app:

![Label color background color](../../assets/en/label-color-background-color.png)

From the attribute inspector, you can also customize the font. Select both labels and select Font > Custom > **Helvetica Neue**:

![Label font custom](../../assets/en/label-font-custom.png)
...
![Label lines number](../../assets/en/label-lines-number.png)

> **NOTE**
>
> The provided storyboard is optimized to have a **variable cell height** depending on the contents of each cell.
>
> ![Row height tableview cell](../../assets/en/row-height-tableview-cell.png)
...
![User defined runtime attributes](../../assets/en/user-defined-runtime-attributes.png)
...
![Field 2 Binding](../../assets/en/field-2-binding.png)
...
![Field 3 Binding](../../assets/en/field-3-binding.png)
...
![Storyboard label display names](../../assets/en/storyboard-label-display-name.png)
...
![Simulator result](../../assets/en/simulator-result.png)
...
![ImageView corner Radius](../../assets/en/imageview-corner-radius.png)
