...
![Xcode](../../assets/en/Discover-Xcode-4D-for-iOS.png)
...
![Build and Run](../../assets/en/Toolbar-Build-and-Run-Xcode-4D-for-iOS.png)

* The dropdown menu next to the **Stop** button indicates which build target you want to run and which Simulator is being used.

![Toolbar Target](../../assets/en/Toolbar-Target-simulator-Xcode-4D-for-iOS.png)

* On the right side of the toolbar, you'll find buttons to change the display.

![Toolbar View buttons](../../assets/en/Toolbar-View-buttons-Xcode-4D-for-iOS.png)

## Editor Area

![Editor Area](../../assets/en/Editor-Xcode-4D-for-iOS.png)
...
![Interface Builder Area](../../assets/en/Interface-Builder-Xcode-4D-for-iOS.png)
...
![Library pane](../../assets/en/Xcode-Library-pane.png)
...
![Navigation tab](../../assets/en/Project-Navigation-Editor-Xcode-4D-for-iOS.png)

* **Search navigator tab**: Allows searching all files in the project.

![Search navigator tab](../../assets/en/Search-Navigator-Xcode-4D-for-iOS.png)
...
![Issue Navigator](../../assets/en/Issue-Navigator-Xcode-4D-for-iOS.png)
