...
![Action section](../../assets/en/Actions-section.png)
...
![Add action creation](../../assets/en/Add-action-creation.png)
...
![Add action parameters](../../assets/en/Add-action-parameters.png)
...
![Edit action creation](../../assets/en/Edit-action-creation.png)
...
![Edit action parameters](../../assets/en/Edit-action-parameters.png)
...
![Delete action creation](../../assets/en/Delete-action-creation.png)

At this point, you will see a **new action** named *"deleteTasks"* with *"Remove"* as the default label.

![Delete action](../../assets/en/Delete-action-final.png)
...
![Delete action creation](../../assets/en/Send-comment-action-creation.png)
...
![Send comment action creation](../../assets/en/Send-comment-action-definition.png)
...
![Create new task](../../assets/en/Action-parameters-addAction.png)
...
![Edit task](../../assets/en/Action-parameters-editAction.png)

Send a comment using the **Send comment** action.

![Send task comment](../../assets/en/Action-parameters-sendComment.png)

And finally you can delete an entity using the **Delete...** action.

![Delete task](../../assets/en/Action-parameters-deleteAction.png)
