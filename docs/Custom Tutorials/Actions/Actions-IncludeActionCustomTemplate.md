...
![Listform templates](../../assets/en/Listform-templates.png)

* **TasksDetail** template folders in *Tasks.4dbase/Resources/Mobile/form/detail folder*

![Detailform template](../../assets/en/Detailform-template.png)
...
![Add table action tag](../../assets/en/Add-table-tag-taskslist.png)
...
![Add entity action tag](../../assets/en/Add-entity-tag-taskslist.png)
...
![Taskslist Forms section](../../assets/en/listform-taskslist-forms-section.png)
...
![Add collection table action tag](../../assets/en/Add-collection-table-tag-taskslist.png)
...
![Add collection entity action tag](../../assets/en/Add-collection-entity-tag-taskslist.png)
...
![TasksCollection Forms section](../../assets/en/listform-taskscollection-forms-section.png)
...
![Add detailform entity action tag](../../assets/en/Detail-form-action-navigationBar.png)
...
![Add detailform entity action tag custom action button](../../assets/en/Detail-form-action-custom-action-Button.png)
