...
The problem is that with MDX, html tags are supported but you need to use the JSX syntax.

So to get the same result, you would write it like this: 
<div style= {{ textAlign: "center", marginTop: "20px", marginBottom: "20px" }}>

<a markdown="1" className="button"
href="https://github.com/4d-for-ios/tutorial-Actions/archive/cf16581214a8a6e4e4067bcff43ac1265ec43ff7.zip">STARTER PROJECT</a>

</div>
-->

<!-- Here's the result (note that the optimal way would be defining a class with these properties) -->
